...
executables = [cx_Freeze.Executable("TextEditor.py", base=base)]


cx_Freeze.setup(
    name = "Ekram's Text Editor",
    options = {"build_exe": {"packages":["tkinter","os"], "include_files":['tcl86t.dll','tk86t.dll', 'TextEditorIcons']}},
    version = "0.01",
