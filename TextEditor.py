...
main_application.title('Ekram\'s Text Editor')
...
# align center btn functionality
...
# defaultextension1 = ['.txt', '.pdf', 'docx']
...
def find_func(event=None):
    ...
    text_find_entry.grid(row=0, column=1, padx=4, pady=4)
    text_replace_entry.grid(row=1, column=1, padx=4, pady=4)
    find_btn.grid(row=2, column=1, padx= 8, pady=6)
    replace_btn.grid(row=3, column=1, padx= 8, pady=6)
